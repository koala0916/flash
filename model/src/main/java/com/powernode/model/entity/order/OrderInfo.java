...
public class OrderInfo extends BaseEntity {
	...
	@Schema(description = "配送员到达拍照：车前照")
	@TableField("car_front_url")
	private String carFrontUrl;

	@Schema(description = "配送员到达拍照：车后照")
    ...
    @Schema(description = "订单状态：1等待接单，2已接单，3配送员已到达，4开始配送，5结束代驾，6未付款，7已付款，8订单已结束，9顾客撤单，10配送员撤单，11事故关闭，12其他")
	@TableField("status")
